...
public class AlipayBookingTest {
    ...
    private static void initializeMockData() {
        ...
        flightrecord.setFlightrecordId("00CA123420250701");
    ...
    private static void runTest() {
        System.out.println("\n========== 支付宝订票测试流程 ==========");
        String flightrecordId = "00CA123420250701";
    ...
    private static void regenerateQrCode() {
        ...
        Integer amount = bookingService.calculateOrderPrice("00CA123420250701", 0, "123456");
        createPayment(orderId, amount);
    }
